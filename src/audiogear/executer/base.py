...
from audiogear.utils.logging import add_task_logger, close_task_logger, get_random_str, get_timestamp, log_pipeline
...
class PipelineExecutor(ABC):
    ...
    def _run_for_rank(self, rank: int, local_rank: int = 0) -> None:
        """
